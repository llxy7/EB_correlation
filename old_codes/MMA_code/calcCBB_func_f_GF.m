...
tabxgrid=Select[(Import[workdir<>"xgrid_HD.dat","Table"]//Flatten),(#<τrei)&];
...
func[tp_]:=NIntegrate[1/afit ((g2$num[tp]g1p$num[t]-g1$num[tp]g2p$num[t])/(g1p$num[tp]g2$num[tp]-g1$num[tp]g2p$num[tp])-apfit/afit (g2$num[tp]g1$num[t]-g1$num[tp]g2$num[t])/(g1p$num[tp]g2$num[tp]-g1$num[tp]g2p$num[tp]))SphericalBesselJ[2,(τrei-t)klist[[kk]]] 1/((τrei-t)^2 klist[[kk]]^2),{t,tp,τrei}(*,WorkingPrecision100*)];

(*func[tp_]:=NIntegrate[1/afit(1/(klist[[kk]]^3 t^2 tp)(klist[[kk]] (t-tp+klist[[kk]]^2 t^2 tp) Cos[klist[[kk]] (t-tp)]+(-1+klist[[kk]]^2 t (t-tp)) Sin[klist[[kk]] (t-tp)])-apfit/afit(-klist[[kk]] (t-tp) Cos[klist[[kk]] (t-tp)]+(1+klist[[kk]]^2 t tp) Sin[klist[[kk]] (t-tp)])/(klist[[kk]]^3 t tp))SphericalBesselJ[2,(τrei-t)klist[[kk]]]1/((τrei-t)^2klist[[kk]]^2),{t,tp,τrei}(*,WorkingPrecision100*)];*)
...
ans=({#,func[#]}&/@xgrid)~Join~{{N[τrei,50],0}};

Export[dumpdir<>"kk_"<>$CommandLine[[-1]]<>".dat",ans];