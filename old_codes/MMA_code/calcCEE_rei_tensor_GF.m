...
dumpdir="/tomerv/tomerv-shared/Sida/b-mode-log-griding/f_"<>ToString[log10f]<>"_L_"<>$CommandLine[[-6]]<>"_tau_"<>$CommandLine[[-5]]<>"_N_"<>$CommandLine[[-4]]<>"_kmax_"<>$CommandLine[[-3]]<>"_nat_tau/ClEE_rei_tensor/uu_"<>$CommandLine[[-2]]<>"_GF/";
...
calcClEE[ww_]:=9/(4 π^3) optdep$rei^2 klist[[uu]]dk[[uu]]klist[[vv]]dk[[vv]]klist[[ww]]dk[[ww]]Θ[klist[[uu]],klist[[vv]],klist[[ww]]](Vr[ww]^2+Vi[ww]^2);
tab2=Table[(((l+2)(l+1))/((2l-1)(2l+1)) SphericalBesselJ[l-2,klist[[uu]] (τ0-τrei)]-(6(l+2)(l-1))/((2l-1)(2l+3)) SphericalBesselJ[l,klist[[uu]] (τ0-τrei)]+(l(l-1))/((2l+1)(2l+3)) SphericalBesselJ[l+2,klist[[uu]] (τ0-τrei)])^2/.l->lmode[[i]],{i,1,Length[lmode]}];
...
ans+=calcClEE[ww]*tab2,{ww,wwmin,wwmax}];
