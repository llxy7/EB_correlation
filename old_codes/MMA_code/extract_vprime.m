workdir="/tomerv/tomerv-shared/Sida/b-mode-log-griding/f_"<>$CommandLine[[-6]]<>"_L_"<>$CommandLine[[-5]]<>"_tau_"<>$CommandLine[[-4]]<>"_N_"<>$CommandLine[[-3]]<>"_kmax_"<>$CommandLine[[-2]]<>"_nat_tau/ndsolve/";
